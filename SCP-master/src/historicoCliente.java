...
public class historicoCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cpf.setBorder(javax.swing.BorderFactory.createTitledBorder("CPF do Cliente"));
        try {
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        String r = nova.listaHisCliente(cpf.getText());
        String[] mov = r.split(";");
        int tam = mov.length;
        for(int i=1;i<tam;i++){
            ...
            JOptionPane.showMessageDialog(null,"Cliente não possui Historico");
        }
